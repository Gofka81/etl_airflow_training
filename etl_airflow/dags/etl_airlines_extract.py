...
with DAG(
    ...
    extract_airlines_task = FlightRadarOperator(
    ...
    etl_transform = SparkSubmitOperator(
        ...
        application='/opt/bitnami/spark/jobs/transform/etl_airlines_transform.py',
...
extract_airlines_task >> sensor_extract >> etl_transform >> load_postgres
